...
private:
  ...
  /// C API reference to BDD Manager (needed to call the C API).
  Cal_BddManager _bddManager;

  /// C API reference to BDD node to be managed.
  Cal_Bdd _bdd;
...
protected:
  ...
  /// `Cal_Bdd`, assuming it already has been by the C API operation.
  //////////////////////////////////////////////////////////////////////////////
...
public:
  ...
  // TODO: move operator overloading up here
